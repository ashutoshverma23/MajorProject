...
const StoryCard = ({ story }) => {
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl overflow-hidden w-80 group flex flex-col transition-transform duration-300 ease-in-out transform hover:scale-105">
      <img
        src={story.image}
        alt={story.title}
